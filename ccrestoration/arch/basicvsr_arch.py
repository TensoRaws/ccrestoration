...
if __name__ == "__main__":
    ...
    model = BasicVSR(num_feat=64, num_block=30, spynet_path="/Users/tohru/Downloads/spynet_sintel_final-3d2a1287.pth")
    state_dict = torch.load("/Users/tohru/Downloads/BasicVSR_Vimeo90K_BIx4-2a29695a.pth", weights_only=True)
    ...
    # b, n, c, h, w
    imgTensorStack = torch.stack([img, img, img, img, img, img, img], dim=1)
    ...
    for i in range(out.shape[1]):
        ...
        cv2.imwrite(f"basicvsr_frame_{i}_out.png", img)
