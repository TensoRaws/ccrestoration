...
SwinIRConfigs = [
    ...
    SwinIRConfig(
        name=ConfigType.SwinIR_classicalSR_DIV2K_s48w8_SwinIR_M_2x,
        url="https://github.com/TensoRaws/ccrestoration/releases/download/model_zoo/SwinIR_classicalSR_DIV2K_s48w8_SwinIR_M_2x.pth",
        hash="ac6d4895f73aa1b3d563937e29dcedcfdff4d401280e248f23db3c6f68e8343b",
        scale=2,
        img_size=48,
        window_size=8,
        depths=[6, 6, 6, 6, 6, 6],
